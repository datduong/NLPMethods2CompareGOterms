...
def get_args():
	...
	parser.add_argument('--ICpath',type=str,default='none',help='IC for the go terms (BP,CC,MF)')
	parser.add_argument('--goAncestor',type=str,default='none',help='ancestors for the go terms (BP,CC,MF)')
	parser.add_argument('--geneAnnotationFile',type=str,default='none',help='go term annotation for the genes (BP,CC,MF)')
	parser.add_argument('--all3',type=int,default=0,help='use 1 to combine all 3 ontologies')
