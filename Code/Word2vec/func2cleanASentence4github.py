...
def tokenize1sent (stringText): 
	tknzString = word_tokenize(stringText.lower())
	return " ".join(i for i in tknzString) 
...
def cleanSentencesInFile (textInFile,removeLongWordsFlag,splitSentencesFlag): ## textInFile: is a string like 'abcdef' 
	...
	outtab="".join("$" for x in punc2remove) ## $ is used as dummy coding to avoid "" concat 2 words. ## some trick found online, http://www.tutorialspoint.com/python/string_maketrans.htm                             
